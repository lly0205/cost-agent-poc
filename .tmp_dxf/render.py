...
VIEWS = {
    "S1_base": (-4839790, 36225, -4691190, 120325),
    "S3_raft": (-4839790, -139272, -4691190, -55172),
    "S5_cols": (-4839790, -307472, -4691190, -223372),
    "S6_beam": (-4839790, -391572, -4691190, -307472),
}
for name, (x0, y0, x1, y1) in VIEWS.items():
    fig = plt.figure(figsize=(28, 16), dpi=110)
